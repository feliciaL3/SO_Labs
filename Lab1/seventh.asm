...
mov AX, 0h
mov ES, AX          ; move ax in ex , respons for memory
...
mov AX, 1301h       ; Set AX register to 1301h, which is the BIOS function for printing a string with attribute. and cursor?
int 10h
message dd "Hello"


;db = individual characters,
;dd = larger strings